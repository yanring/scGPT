...
hyperparameter_defaults = dict(
    ...
    dataset_name="ms",
    do_train=True,
    # load_model="/home/scratch.zijiey_sw/Algorithm/scGPT/scgpt/tutorials/save/dev_set3",
    load_model="/home/scratch.zijiey_sw/Algorithm/scGPT/scgpt/save/scGPT_human",
    mask_ratio=0.0,
    epochs=15,
    n_bins=51,
...
if dataset_name == "ms":
    ...
    adata = sc.read(Path('/home/scratch.zijiey_sw/Algorithm/scGPT/scgpt/save/new/gears_data/set3_train_gears.h5ad'))
    adata_test = sc.read(Path('/home/scratch.zijiey_sw/Algorithm/scGPT/scgpt/save/new/gears_data/set3_test_gears.h5ad'))
    adata.obs["celltype"] = adata.obs['condition'].str.split('+').str[0].astype("category")
    adata = adata[adata.obs["celltype"]!='ctrl', :]
    adata_test.obs["celltype"] = adata_test.obs['condition'].str.split('+').str[0].astype("category")
    adata_test = adata_test[adata_test.obs["celltype"]!='ctrl', :]
    ...
    adata = adata.concatenate(adata, batch_key="str_batch")
...
if config.load_model is not None:
    ...
    vvocab = GeneVocab.from_file(vocab_file)
